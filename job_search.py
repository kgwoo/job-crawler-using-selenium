...
def job_info(max):
    ...
    for page in range(1,max+1):
        ...
        job_name = driver.find_elements_by_xpath("//h4[@class='position-title']//a")
        location = driver.find_elements_by_xpath("//ul[@class='company-info']//li[@class='location']")
        experience = driver.find_elements_by_xpath("//ul[@class='company-info']//li[@class='experience']")
  ...
  #딕셔너리를 반복으로 돌린 후, 값을 리스트에 넣어주어야 각 해당 부분의 value값이 나온다.